...
//         <div className="flex flex-col items-center mx-auto min-h-[50vh] max-w-5xl px-4">
...
//               PICTURE STUDIOS
//             </div>
//             <h1 className="text-5xl sm:text-6xl md:text-7xl text-black dark:text-white mb-3 md:mb-4">
//               Become your own 
//             </h1>
//             <h1 className="italic text-4xl sm:text-5xl md:text-6xl text-black font-semibold dark:text-white px-4 mb-4 md:mb-8">
//               photographer
//             </h1>
//             <p className="text-[16px] text-center  mx-auto max-w-3xl max-md:w-[650px] md:text-[18px] text-black/70 dark:text-white/70  leading-relaxed mt-4 px-4 mb-12">
...
//             </button>
//             <p className="text-[14px] text-center max-w-2xl mx-auto   text-black dark:text-white/70  leading-relaxed mt-1 px-4 mb-8">No credit card required</p>
//           </div>
//         </div>
//     </div>
//   )
